...
|---|---|---|---|---|---|---|---|---|---|---|
| R-007 | T-041: every send-followups read chunked, paged and throwing | CHANGE | n/a | 2026-09-19 12:19 | 2026-09-19 12:19 | 11s elapsed · active: no marks | - | 32.6s | BLOCKED | T-041: 8 reads chunked/paged/throwing; load.test.ts 5/5 (4/5 red against the pre-fix shape); check:edge 27 files clean; deno test 8 passed. Gate BLOCKED on pre-existing G8 courses.tsx (T-023). |
